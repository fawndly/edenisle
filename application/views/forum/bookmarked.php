 <!-- Crysandrea engine by Tyler Diaz (https://github.com/Pixeltweak/Crysandrea) --><?php $this->load->view('forum/forum_navigation', array('routes' => $routes, 'active_url' => $active_url)); ?>
...
<?php else: ?>
    ...
    <div class="empty_notice">
        You have no bookmarked topics yet. You should <a href="/forums">explore the forums</a> to find some!
    </div>
<?php endif; ?>
