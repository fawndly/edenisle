 <!-- Crysandrea engine by Tyler Diaz (https://github.com/Pixeltweak/Crysandrea) --><?php $this->load->view('friends/friend_navigation', array('routes' => $routes, 'active_url' => $active_url)); ?>

<div style="margin:10px 0">
    <?php if ($this->input->get('sent') !== NULL): ?>
    ...
    <?php if ($this->input->get('missing') !== NULL): ?>
