 <!-- Crysandrea engine by Tyler Diaz (https://github.com/Pixeltweak/Crysandrea) --><style type="text/css">
    .friend_actions {
        position: relative;
        background: #fff;
...
<?php if ($this->input->get('acceped') !== NULL): ?>
...
<?php if ($this->input->get('removed') !== NULL): ?>
    <div class="alert alert-success">
        <button type="button" class="close" data-dismiss="alert">×</button>
    ...
    <div class="feature_content">
        <div style="height:185px; width:727px; background:url(/images/banners/friend_background.jpg); overflow:hidden; position:relative;">
            ...
            <div style="float:right; width:530px; margin-right:10px;">
                <div class="clearfix">
                    <h3 class="left username_data"><span id="data_username"><?php echo $user['username'] ?></span> <span id="user_timestamp"></span></h3>
...
<?php else: ?>
    ...
    <div class="empty_notice">
        No friends to show. Why don't you <a href="/forum">explore the forums</a> and meet someone?
    </div>
<?php endif ?>
