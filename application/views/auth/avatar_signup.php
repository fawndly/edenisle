        ...
        <div class="clearfix">
            <div style="float:left; width:180px; margin-left:-25px; text-align:center">
                ...
                <div class="clearfix" style="margin:0 20px;">
                    <a href="#" class="base_pallet <?php echo (in_array(1, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="1" data-item-type="base" style="background:#fee3d4;"></a>
                    ...
                    <a href="#" class="base_pallet <?php echo (in_array(2, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="2" data-item-type="base" style="background:#db9f83;"></a>
                    <a href="#" class="base_pallet <?php echo (in_array(4, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="4" data-item-type="base" style="background:#964227;"></a>
                    <a href="#" class="base_pallet <?php echo (in_array(5, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="5" data-item-type="base" style="background:#561c08;"></a>
                        <a href="#" class="base_pallet <?php echo (in_array(6, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="6" data-item-type="base" style="background:#561c08;"></a>
                </div>
                <br />
            </div>
            <div class="left" style="width:365px;">
                ...
                <div class="choice_select pants_group">
                    ...
                    <h5 style="margin:8px 0 3px">Choose a pair of shoes:</h5>
                <div class="choice_select accessory_group">
                    <?php foreach ($signup_options['shoes'] as $key => $item): ?>
                        <a class="equippable_default <?php echo (in_array($item['item_id'], $equipped_items) ? 'default_equipped' : '') ?>" data-item-type="shoes" data-item-id="<?php echo $item['item_id'] ?>" href="#"><img src="/images/items/<?php echo $item['thumb'] ?>" width="42" height="42" alt=""></a>
                    <?php endforeach ?>
                </div>
