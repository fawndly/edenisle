        ...
        <div class="clearfix">
            <div style="float:left; width:180px; margin-left:-25px; text-align:center">
                ...
                <div class="clearfix" style="margin:0 20px;">
                    <a href="#" class="base_pallet <?php echo (in_array(1, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="5" data-item-type="base" style="background:#fee3d4;"></a>
                    <a href="#" class="base_pallet <?php echo (in_array(2, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="3" data-item-type="base" style="background:#f7c4ab;"></a>
                    <a href="#" class="base_pallet <?php echo (in_array(3, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="9" data-item-type="base" style="background:#db9f83;"></a>
                    <a href="#" class="base_pallet <?php echo (in_array(4, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="12" data-item-type="base" style="background:#964227;"></a>
                    <a href="#" class="base_pallet <?php echo (in_array(5, $equipped_items) ? 'default_skin' : '') ?>" data-item-id="13" data-item-type="base" style="background:#561c08;"></a>
                </div>
                <br />
