<!-- Crysandrea engine by Tyler Diaz (https://github.com/Pixeltweak/Crysandrea) --><?php $this->load->view('layout/feature_navigation', array('routes' => $routes, 'active_url' => $active_url, 'core' => 'staff_panel')); ?>
<br />
<div class="clearfix">
    <div class="span4">
    ...
    <div class="span4" id="selected_items">
        ...
        <div class="media hide" id="skeleton_template">
            <img class="media-object pull-left" data-src="holder.js/64x64" src="http://Sapherna.com//images/items/d834e29075486ea8fbf9056eaaf0eb1d.png" id="item_thumbnail">
