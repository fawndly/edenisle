    ...
    <div class="span4">
            ...
            <div class="clearfix widget_content">
                <?php if (count($notifications) > 0): ?>
                    <?php foreach ($notifications as $notification): ?>
                        <div class="media">
                            <a class="pull-left" href="#"><img class="media-object" src="http://Sapherna.com/images/avatars/<?php echo $notification['sender_id'] ?>_headshot.png" width="42" height="42"></a>
        ...
        <div class="dashboard_widget">
            ...
            <div class="clearfix widget_content" style="background:#ffa;">
                <div class="media">
                    <a class="pull-left" href="#"><img class="media-object" src="http://Sapherna.com/images/avatars/<?php echo $spotlight_topic['user_id'] ?>_headshot.png" width="42" height="42"></a>
                    <div class="media-body">
                        <div style="margin-bottom:2px;">
                            <small>
