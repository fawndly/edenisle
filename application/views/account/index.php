...
<div id="dropdown-1" class="dropdown-menu has-tip" style="max-width:220px; padding:10px; line-height:1.4">
    <h5 style="background:#ff8; display:inline;">Changing your username will cost 1,000 Ores.</h5>
    ...
    <?php if ($user['user_Ores'] >= 1000): ?>
        <a href="#" id="change_username" class="main_button" style="color:white">OK, I still want to change it</a>
    <?php else: ?>
        <div style="text-align:center; color:#888; font-size:11px; margin-top:5px; border-top:1px solid #ccc; padding-top:5px;">You do not have enough Ores for this.</div>
    <?php endif ?>
</div>
