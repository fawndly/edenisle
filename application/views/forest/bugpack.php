...
<?php if(!empty($insects)): ?>
    <a href="/forest/sell_all_bugs" class="btn sell_all">Sell all</a>
    <a href="/forest/sell_all_but_one" class="btn sell_all">Sell all but one of each</a>
<?php endif; ?>
<div class="clearfix" style="margin:5px 0;">
    <?php foreach ($insects as $insect_id => $insect): ?>
        <div class="bug_canaster">
            ...
            <span class="price"><img src="/images/icons/little_Ores.png" alt="" width="13" height="13" style="margin-top:-2px;"> <?php echo $insect['price'] ?></span>
