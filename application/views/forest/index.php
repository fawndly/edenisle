...
<div class="clearfix">
    <div id="bug_showcase" class="center_shine">
        ...
        <div class="hide hunt_template">
            ...
            <p id="bug_data"><img src="/images/icons/little_Ores.png" style="margin-top:-3px" width="18" height="18" alt=""> <span id="total_bug_value">16</span> Ores &bull; Rarity: <span id="bug_rarity">Uncommon</span></p><br />
        </div>
    </div>
