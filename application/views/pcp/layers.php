...
<div class="clear"></div>
    ...
    <div class="right">
        Move after:
        <select name="layer_move">
            <?php foreach($layers as $layer_part): ?><option value="<?=$layer_part['order']?>"><?=$layer_part['name']?></option><?php endforeach; ?>
        </select>
        <?=button('Move layer', 'cute')?>
    </div>
</form>
<div class="clear"></div>
<br />
    ...
    <ul class="form">
        ...
        <li>
            ...
            <select name="layer_move">
                ...
                <option value="<?=$layer_part['order'] ?>"><?=$layer_part['name']?></option>
                <?php endforeach; ?>
            </select>
        </li>
