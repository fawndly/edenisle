<!-- Crysandrea engine by Tyler Diaz (https://github.com/Pixeltweak/Crysandrea) --><style type="text/css" media="screen">
    h2 {
    ...
    .item_found {
        margin-top:5px;
        margin-right:8px;
        background:#ddd url(http://Sapherna.com/images/arrow_pointers.png)repeat-x left top;
        padding:10px 0 0;
        overflow:hidden;
    }
    .item_found div {
    ...
    .item_found_left {
        float:left;
        width:215px;
        background:#ddd url(http://Sapherna.com/images/arrow_pointers.png)repeat-x left -50px;
        padding:0 0 0 10px;
        overflow:hidden;
    }
    .item_found_left div {
    ...
    #loading {
        ...
        text-align:center;
        margin:20px 60px;
        background:white url(http://Sapherna.com/images/loaders/ajax.gif)no-repeat 11px 11px;
