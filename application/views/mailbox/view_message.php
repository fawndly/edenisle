<!-- Crysandrea engine by Tyler Diaz (https://github.com/Pixeltweak/Crysandrea) --><?php $this->load->view('mailbox/mailbox_navigation', array('routes' => array('index' => '&lsaquo; &nbsp;Return to inbox'), 'active_url' => $active_url)); ?>
