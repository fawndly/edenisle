<!-- Crysandrea engine by Tyler Diaz (https://github.com/Pixeltweak/Crysandrea) --><?php $this->load->view('mailbox/mailbox_navigation', array('routes' => $routes, 'active_url' => $active_url)); ?>
...
<?php if ($this->input->get('success')): ?>
    <?php $this->load->view('partials/notices/success', array('header' => 'Success!', 'data' => htmlentities($this->input->get('success')))) ?>
<?php endif ?>
