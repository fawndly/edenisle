<!-- Crysandrea engine by Tyler Diaz (https://github.com/Pixeltweak/Crysandrea) --><div class="row">
    <div class="span6">
          ...
          <fieldset>
            ...
            <select class="input" name="issue">
                ...
                <optgroup label="- Other -">
                    ...
                    <option value="Ores Refund">Ore Refund</option>
            ...
            <div class="hide" id="relevant_url">
                ...
                <input type="text" placeholder="http://Sapherna.com/" name="url" />
