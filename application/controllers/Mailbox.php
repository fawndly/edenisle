...
class Mailbox extends CI_Controller
{
  ...
  public function reply_message($message_id = 0)
  {
    ...
    $this->form_validation->set_rules('title', 'Title', 'required|min_length[1]|max_length[42]');
  ...
  public function create_message()
  {
    ...
    $this->form_validation->set_rules('title', 'Title', 'required|min_length[1]|max_length[42]|htmlentities');
    $this->form_validation->set_rules('to', 'Receiver', 'required|htmlentities');
    $this->form_validation->set_rules('message', 'Message', 'required|htmlentities');
