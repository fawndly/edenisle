...
class Avatar extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->system->view_data['scripts'][] = '/global/js/avatar/index.js?cache=1478657268';
    ...
    function headshot($user_id = NULL, $gen = false)
    {
        ...
        if($gen != false):
            ...
            // save the thumb
            imagecopy($baseimage, $image, 0, 0, 69, 50, 60, 60);
            imagealphablending($baseimage,true);
            imagesavealpha($baseimage, true);
            ...
            if( ! $path1):
                ...
                // save the thumb
                imagecopy($baseimage, $image, 0, 0, 69, 58, 60, 60);
                imagealphablending($baseimage,true);
                imagesavealpha($baseimage, true);
                imagepng($baseimage,$path2);
                imagedestroy($image);
