...
class Trade_Market_Accepting_State implements Trade_Market_State {
    ...
    public function commit() {
        ...
        $this->trade_market->CI->accountant->setCurrencyType('ores');
        if ($this->trade_market->trade->sender_ores > 0):
            $this->trade_market->CI->accountant->setOwner($this->trade_market->trade->trade_sender)->withdraw($this->trade_market->trade->sender_ores);
            $this->trade_market->CI->accountant->setOwner($this->trade_market->trade->trade_receiver)->deposit($this->trade_market->trade->sender_ores);
        endif;
        if ($this->trade_market->trade->receiver_ores > 0):
            $this->trade_market->CI->accountant->setOwner($this->trade_market->trade->trade_receiver)->withdraw($this->trade_market->trade->receiver_ores);
            $this->trade_market->CI->accountant->setOwner($this->trade_market->trade->trade_sender)->deposit($this->trade_market->trade->receiver_ores);
        endif;
