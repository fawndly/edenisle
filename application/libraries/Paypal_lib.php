...
class Paypal_Lib {
    ...
    function button($value)
    {
        ...
        $this->submit_btn = '<button name="pp_submit" class="main_button">Donate <span id="total_donation">$5</span></button>';
    }
    ...
    {
        $str = '';
        $str .= '<form method="post" style="display:inline;" action="'.$this->paypal_url.'" name="'.$form_name.'"/>' . "\n";
